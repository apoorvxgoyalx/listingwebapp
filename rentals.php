...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST['filter_bedrooms'])) {
        $filter_bedrooms = $_POST['filter_bedrooms'];
    }
}

$sql = "SELECT * FROM rentals WHERE 1";

if (!empty($filter_location)) {
    $sql .= " AND location LIKE '%$filter_location%'";
}
if (!empty($filter_bedrooms)) {
    $sql .= " AND bedrooms >= $filter_bedrooms";
}
    ...
    <div class="container">
        ...
        <div class="sidebar">
            <form method="post" action="rentals.php">
                ...
                <h2>Filter by Bedrooms</h2>
                <input type="number" name="filter_bedrooms" value="<?php echo $filter_bedrooms; ?>" placeholder="Enter bedrooms">
        ...
        <div class="rental-listings">
            <?php foreach ($rentals as $rental): ?>
                <div class="rental">
                    ...
                    <p><strong>Bedrooms:</strong> <?php echo $rental['bedrooms']; ?></p>
                    <p><strong>Description:</strong><br><?php echo $rental['description']; ?></p>
                    <form method="POST" action="book_rental.php">
